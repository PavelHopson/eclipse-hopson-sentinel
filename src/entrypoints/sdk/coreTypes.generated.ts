/**
 * SDK core types derived from the runtime Zod schemas.
 *
 * The imported source snapshot did not include the original generated output,
 * which removed the public SDK types and caused cascading implicit-any errors.
 * Keeping the aliases tied to the schemas preserves one source of truth until a
 * standalone code generator is restored.
 */
