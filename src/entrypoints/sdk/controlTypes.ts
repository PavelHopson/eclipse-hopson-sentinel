/**
 * SDK control protocol types derived from the runtime validation schemas.
 *
 * These aliases deliberately stay coupled to controlSchemas.ts so bridge,
 * transport, and external SDK consumers share the same protocol contract.
 */
...
// Kept here for compatibility with transports that consume the complete
// stdout protocol from the control-types entrypoint.
